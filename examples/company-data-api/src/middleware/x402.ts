      ...
      accepts: [
        {
          ...
          resource: req.path,
          description: process.env.SERVICE_DESCRIPTION || 'Company data API - returns funding, pricing, team size from database',
          ...
          extra: {
            ...
            version: '2',
            requestSchema: {
              companyName: 'string (optional) - e.g. "GitHub Copilot", "Cursor", "Anthropic"',
              domain: 'string (optional) - e.g. "github.com", "cursor.sh"',
              industry: 'string (optional) - e.g. "AI Coding Assistants", "AI Language Models"'
            },
            exampleRequest: {
