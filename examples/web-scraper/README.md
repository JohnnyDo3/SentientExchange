# Web Scraper Service (x402-enabled)

AI-powered web scraping service for competitor analysis. Extracts structured data from websites including pricing, features, contact information, and metadata.
...
SERVICE_DESCRIPTION=AI-powered web scraping service
PORT=3003
...
```bash
# Build image
docker build -f docker/Dockerfile -t web-scraper:latest .

# Run container
docker run -p 3003:3003 --env-file .env web-scraper:latest
