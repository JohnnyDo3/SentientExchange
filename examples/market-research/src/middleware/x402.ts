      ...
      accepts: [
        {
          ...
          resource: req.path,
          description: process.env.SERVICE_DESCRIPTION || 'Market research - queries market databases for industry data',
          ...
          extra: {
            ...
            version: '2',
            requestSchema: {
              industry: 'string (optional) - Choose from: "AI Coding Assistants", "Large Language Models", "AI Development Platforms" or similar terms',
              metricType: 'string (optional) - One of: "market-size", "growth-rate", "key-players", "trends", "all"',
              region: 'string (optional) - e.g. "Global", "North America", "Europe", etc.'
            },
            exampleRequest: {
