...
const USDC_CONTRACT = '4zMMC9srt5Ri5X14GAgXhaHii3GnPAEERYPJgZJDncDU'; // Solana USDC devnet
      ...
      accepts: [
        {
          ...
          resource: req.path,
          description: process.env.SERVICE_DESCRIPTION || 'Copywriter - LLM-based marketing copy generation using Claude',
          ...
          extra: {
            ...
            version: '2',
            requestSchema: {
              type: 'string (required) - One of: "landing-page", "product-description", "email", "ad-copy", "blog-post"',
              product: 'string (required) - Name/description of the product',
              targetAudience: 'string (optional) - e.g. "developers", "startups", "enterprises"',
              tone: 'string (optional) - One of: "professional", "casual", "technical", "persuasive"',
              length: 'string (optional) - One of: "short", "medium", "long"'
            },
            exampleRequest: {
              type: 'product-description',
              product: 'AgentCode AI - AI coding assistant',
